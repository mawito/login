						...
						<div class="login-container">
							<div class="center">
								<h1>
									...
									<span class="red">Licoreria </span>
									<span class="white" id="id-text2">Mil Amores</span>
								</h1>
								<h4 class="blue" id="id-company-text">&copy; Login Y Registro</h4>
							</div>
